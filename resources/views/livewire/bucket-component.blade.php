<div class="bg-blue-200 mt-2 px-1 pb-2 rounded-md">
    <div class="flex flex-row">
        <div class="flex text-xl justify-center my-2 px-0">
            <input class="w-full text-left text-lg font-bold bg-blue-200 border-0" value="{{ $bucket->title }}" type="text" name="title" id="title" wire:model.lazy="bucketTitle" wire:change="updateBucket" />
        </div>
